...
from .models import WaterIntake, Sleep, Meditation, WellnessAnalysis, Exercise
...
# Register individual Wellness models for admin interface (optional)
...
class MeditationAdmin(admin.ModelAdmin):
    list_display = ('user', 'amount', 'target_goal')
    search_fields = ('user__username',)
    list_filter = ('timestamp',)
...
class ExerciseAdmin(admin.ModelAdmin):
    list_display = ('user', 'name', 'duration', 'intensity', 'target_goal')
